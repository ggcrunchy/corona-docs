...
> __Keywords__			CORONA_NATIVE_PRODUCT, C, CoronaGraphics.h, CoronaObjectBooleanResultParams
...
``````c
void (*method)( const CoronaDisplayObject * self, void * userData, int * result )`
``````
