...
For instance, see the ["Qualifiers"](https://www.khronos.org/opengles/sdk/docs/reference_cards/OpenGL-ES-2_0-Reference-card.pdf) section in this OpenGL ES 2.0 reference card. With **mediump** our _D_ is only guaranteed to be an underwhelming 1024.
